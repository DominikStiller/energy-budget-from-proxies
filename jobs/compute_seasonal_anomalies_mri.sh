...
echo "Starting MRI-ESM2-0 piControl"
pixi run --frozen python lmrecon/scripts/compute_seasonal_averages.py MRI-ESM2-0 piControl lmrecon \
  && pixi run --frozen python lmrecon/scripts/compute_seasonal_anomalies.py MRI-ESM2-0 piControl \
  && pixi run --frozen python lmrecon/scripts/compute_seasonal_detrended_anomalies.py MRI-ESM2-0 piControl
