...
echo "Starting MPI-ESM1-2-LR piControl"
pixi run --frozen python lmrecon/scripts/compute_seasonal_averages.py MPI-ESM1-2-LR piControl lmrecon \
  && pixi run --frozen python lmrecon/scripts/compute_seasonal_anomalies.py MPI-ESM1-2-LR piControl \
  && pixi run --frozen python lmrecon/scripts/compute_seasonal_detrended_anomalies.py MPI-ESM1-2-LR piControl
